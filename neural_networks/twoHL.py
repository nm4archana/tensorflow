...
'''
No.of layers is initialized as 100
'''
layer_1_nodes = 1000
layer_2_nodes = 400
...
'''
Second layer : 400 Nodes
'''
weight2 = tf.Variable(tf.random_normal([layer_1_nodes, layer_2_nodes]))
#bias2 = tf.Variable(tf.random_normal([layer_2_nodes]))
bias2 = tf.Variable(tf.zeros([layer_2_nodes]))
...
Output
'''
weight3 = tf.Variable(tf.random_normal([layer_2_nodes,y_distinct_classes]))
#bias2 = tf.Variable(tf.random_normal([layer_3_nodes]))
bias3 = tf.Variable(tf.zeros([y_distinct_classes]))
...
'''
Number of epochs is  set to 100000
'''
n_epoch = 10000
